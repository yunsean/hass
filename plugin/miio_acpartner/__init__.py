...
RADIO_SERVICE_ACTIVITY_SCHEMA = ENTITY_SERVICE_SCHEMA.extend({
    vol.Optional(ATTR_ACTIVITY): cv.string
})

RADIO_SERVICE_PLAY_RADIO_SCHEMA = ENTITY_SERVICE_SCHEMA.extend({
    vol.Required(ATTR_PROGRAMID): cv.string,
})

RADIO_SERVICE_SET_VOLUME_SCHEMA = ENTITY_SERVICE_SCHEMA.extend({
    vol.Required(ATTR_VOLUME): cv.string,
})

RADIO_SERVICE_PLAY_RINGTONE_SCHEMA = ENTITY_SERVICE_SCHEMA.extend({
    vol.Required(ATTR_RINGTONEID): cv.string,
    vol.Optional(ATTR_VOLUME): cv.string
})

RADIO_SERVICE_PLAY_TTS_SCHEMA = ENTITY_SERVICE_SCHEMA.extend({
    vol.Required(ATTR_MESSAGE): cv.string,
    vol.Optional(ATTR_VOLUME): cv.string
})

RADIO_SERVICE_PLAY_VOD_SCHEMA = ENTITY_SERVICE_SCHEMA.extend({
